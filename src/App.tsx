                  ...
                  return (
                    <button key={g.id} onClick={() => { tap(); setRosaGirl(g.id); }} style={{ ...css('position:absolute;display:flex;flex-direction:column;align-items:center;gap:4px;background:none;transform:translate(-50%,-50%)'), top: s.top, left: s.left }}>
                      ...
                      <div style={{ ...css('position:relative;width:56px;padding:6px 4px 5px;border-radius:11px;border:2px solid #15131a;box-shadow:2px 2px 0 #15131a;display:flex;flex-direction:column;align-items:center'), background: `linear-gradient(160deg,${g.c1},${g.c2})` }}>
                        <div style={css("position:absolute;top:4px;left:4px;font-family:'Space Mono',monospace;font-weight:700;font-size:12px;line-height:1;color:#c6ff3d;background:#15131a;padding:2px 5px;border-radius:7px;box-shadow:1px 1px 0 rgba(0,0,0,.5)")}>{ov(g.stats)}</div>
              ...
              {sel && (
                <div onClick={() => setRosaGirl(null)} style={css('position:fixed;inset:0;z-index:900;background:rgba(11,9,16,.86);display:flex;align-items:center;justify-content:center;padding:24px')}>
                  <div onClick={(e) => e.stopPropagation()} style={{ ...css("position:relative;width:100%;max-width:280px;text-align:center;padding:16px 14px;border-radius:24px;border:3px solid #15131a;box-shadow:7px 7px 0 #15131a;overflow:hidden;animation:pop .3s ease both"), background: `linear-gradient(160deg,${sel.c1},${sel.c2})` }}>
                    <div style={css('display:flex;justify-content:space-between;align-items:flex-start')}><div style={css("font-family:'Space Mono',monospace;font-weight:700;font-size:28px;line-height:1;color:#c6ff3d;background:#15131a;padding:5px 11px;border-radius:12px;box-shadow:2px 2px 0 rgba(0,0,0,.4)")}>{ov(sel.stats)}</div><div style={{ ...css("font-family:'Space Mono',monospace;font-size:9px;background:#15131a;padding:3px 7px;border-radius:7px;align-self:center"), color: sel.c1 }}>{sel.role}</div></div>
